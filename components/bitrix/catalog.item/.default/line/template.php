...
<div class="row product-item">
	...
	<div class="col-xs-12 col-sm-6 col-md-3 col-lg-2">
		<a class="product-item-image-wrapper" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
			...
			<span class="product-item-image-slider-slide-container slide" id="<?=$itemIds['PICT_SLIDER']?>"
				...
				if ($showSlider)
				{
					...
					{
						$renderImage = CFile::ResizeImageGet($photo["ID"], Array("width" => 350, "height" => 350), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false);
						?>
		...
		<a href="javascript:" class="btn like-btn"></a>
	</div>
	<?
	if (!$haveOffers)
	{
				...
				<div id="<?=$itemIds['PROP_DIV']?>">
					...
					foreach ($arParams['SKU_PROPS'] as $skuProperty)
					{
						...
						if (!isset($item['SKU_TREE_VALUES'][$propertyId]))
							continue;
						?>
						<div class="product-item-info-container prop_block_<?=$propertyId;?>" data-entity="sku-block">
									...
									<div class="product-item-scu-list">
										<ul class="product-item-scu-item-list">
											...
											foreach ($skuProperty['VALUES'] as $value)
											{
												...
												{
													?>
													<li class="product-item-scu-item-color-container prop_block__value_<?=$value['ID'];?>" title="<?=$value['NAME']?>"
												...
												{
													?>
													<li class="product-item-scu-item-text-container prop_block__value_<?=$value['ID'];?>" title="<?=$value['NAME']?>"
														data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>">
