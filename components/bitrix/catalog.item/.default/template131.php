																...
																<div class="product-item-scu-list">
																	<ul class="product-item-scu-item-list">
																		...
																		foreach ($skuProperty['VALUES'] as &$value)
																		{
																			...
																			{
																				?>
																				<li class="product-item-scu-item-color-container block_prop_<?=$propertyId?>" title="<?=$value['NAME']?>"
																					data-treevalue="<?=$propertyId?>_<?=$value['ID']?>"
																					data-onevalue="<?=$value['ID']?>">
																					<div class="product-item-scu-item-color-block  prop_value_<?=$propertyId?>_<?=$value['ID']?>">
																			...
																			{
																				?>
																				<li class="product-item-scu-item-text-container block_prop_<?=$propertyId?>" title="<?=$value['NAME']?>"
																					data-treevalue="<?=$propertyId?>_<?=$value['ID']?>"
																					data-onevalue="<?=$value['ID']?>">
																					<div class="product-item-scu-item-text-block prop_value_<?=$propertyId?>_<?=$value['ID']?>">
