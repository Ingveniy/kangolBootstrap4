...
<div class="container catalog_container catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>" >
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		?>
		<!-- items-container -->
        <div class="row <?=$rowData['CLASS']?>" data-entity="items-row" style="flex-wrap: wrap">
		<?
