...
<tr>
	...
	<td class="field">
		<input type="text" name="quantity" id="js-popup-quantity-<?=$arResult["UNIQUE_CODE"]?>" value="1" class="sale-order-count">
		<div class="order-popup-quantity">
			<a href="#" onClick="return changeQuantity('top', <?=$arResult["UNIQUE_CODE"]?>);" class="order-popup-top"></a>
			<a href="#" onClick="return changeQuantity('down', <?=$arResult["UNIQUE_CODE"]?>);" class="order-popup-down"></a>
		</div>
	...
	<tr>
		...
		<td class="field">
			<label class="popup-personal-data">
				<input class="popup-personal-process" type="checkbox" name="PERSONAL_DATA" value="Y" checked>
				<div><?=str_replace("#PAGE_URL#", $arParams["PERSONAL_DATA_URL"], GetMessage("SALE_PERSONAL_DATA_TEXT"))?></div>
			</label>
		</td>
	</tr>
<?endif;?>
